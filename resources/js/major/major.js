...
(() => {
    ...
    const DOM = {
        ...
        importModalCard: document.getElementById('majorImportModalCard'),
        importForm: document.getElementById('majorImportForm'),
        importDropzone: document.getElementById('majorImportDropzone'),
        importFileInput: document.getElementById('majorImportFile'),
        importFileName: document.getElementById('majorImportFileName'),
        importClearBtn: document.getElementById('majorImportClearBtn'),
        importSubmitBtn: document.getElementById('majorImportSubmitBtn'),
        importSpinner: document.getElementById('majorImportSpinner'),
        importSubmitLabel: document.getElementById('majorImportSubmitLabel'),

        importResultsModal: document.getElementById('majorImportResultsModal'),
        importResultsModalCard: document.getElementById('majorImportResultsModalCard'),
        importResultsBody: document.getElementById('majorImportResultsBody'),
    };
